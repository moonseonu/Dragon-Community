...
//
//			Packet recvPack;
//			memcpy(&recvPack, ptr->buf, sizeof(Packet));
//			recvPackets.push_back(recvPack);
//			printf("%d", recvPack.playerID);
//
//			if (recvPackets.size() == 2) {
//				const char* gameStartMsg = "Game start!";
//				WSABUF sendBuf;
//				sendBuf.buf = (char*)gameStartMsg;
//				sendBuf.len = strlen(gameStartMsg);
//				DWORD sendbytes;
//				ZeroMemory(&ptr->overlapped, sizeof(ptr->overlapped));
//				retval = WSASend(ptr->sock, &sendBuf, 1,
